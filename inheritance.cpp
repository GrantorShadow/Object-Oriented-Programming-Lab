...
class increment : public ERP
{
	public:
	int workday,holiday,inc,slab;
	int total_inc;
	void calc(int workday,int holiday)
	{
		inc=(workday-holiday);
		cout<<"ENTER YOUR EMP SLAB"<<endl;
		cin>>slab;
		total_inc=slab*inc;
	}
	void display()
	{
		cout<<"INCREMENT IS:"<<total_inc+sal;
	}
};
...
int main()
{
	...
	cout<<endl;
	ERP("Max","Ph.d",171123,181217,12000,45,"Lecturer") ;
	ERP V1;
	increment V2;	
	do
	{
		...
		cout<<"PRESS 5 FOR CALCULATING INCREMENT:"<<endl;
		...
		cin>>choice;
			...
			switch (choice)
			{
				...
				case 5:
				cout<<"DISPLAY OF INCREMENT"<<endl;
				cout<<endl;
				cin>>wh;
				cin>>hol;
				V2.calc(wh,hol);
